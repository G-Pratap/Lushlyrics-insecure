...
from mock_patch_main import len_joke, get_joke

class TestJoke(unittest.TestCase):

    @patch('mock_patch_main.get_joke')
    def test_len_joke(self, mock_get_joke):
        mock_get_joke.return_value = 'one'
        self.assertEqual(len_joke(), 3)

    @patch('mock_patch_main.requests')
...
# from mock_patch_main import get_joke, len_joke

# class TestJoke(unittest.TestCase):

#     @patch('mock_patch_main.get_joke')
#     def test_len_joke(self, mock_get_joke):
#         # mock_get_joke = MagicMock()
#         mock_get_joke.return_value = 'one'
#         self.assertEqual(len_joke(), 3)
